...
export const languageData = {
    ...
    en: {
        ...
        uniSelListDesc: `Explore our network of prestigious universities across the globe. Find
                        your dream institution among our trusted partners.`,
        searchUniversities: 'Search universities...',
        allCountries: 'All Countries',
        tokyoUniversity: 'Tokyo University',
        tokyoJapan: 'Tokyo, Japan',
        kyotoUniversity: 'Kyoto University',
        kyotoJapan: 'Kyoto, Japan',
        harvardUniversity: 'Harvard University',
        cambridgeMassachusetts: 'Cambridge, Massachusetts',
        stanfordUniversity: 'Stanford University',
        stanfordCalifornia: 'Stanford, California',
        universityOxford: 'University of Oxford',
        oxfordEngland: 'Oxford, England',
        universityCambridge: 'University of Cambridge',
        cambridgeEngland: 'Cambridge, England',
        universityToronto: 'University of Toronto',
        torontoOntario: 'Toronto, Ontario',
        universityBritishColumbia: 'University of British Columbia',
        vancouverBC: 'Vancouver, BC',
        universityMelbourne: 'University of Melbourne',
        melbourneVictoria: 'Melbourne, Victoria',
        ...
        docTypesHeader: ' Documents We Help With',
        docTypesDesc: `We guide you through every step of document preparation to ensure compliance, accuracy, and embassy 
                    approval. Our expert team ensures your documentation is complete and professionally prepared.`,
        docTypesTitle_1: `Academic Transcripts & Certificates`,
        docTypesDesc_1: `We assist in organizing and verifying your academic records to meet university and embassy requirements.`,
        docTypesTitle_1_details_1: 'Degree certificates and mark sheets from all institutions attended',
        docTypesTitle_1_details_2: 'Official transcripts with proper authentication and attestation',
        ...
        docTypesTitle_4_details_2: '2-3 recommendation letters from professors or employers',
        docTypesTitle_4_details_3: 'Letters formatted according to university and visa requirements',
        docTypesTitle_4_details_4: 'Proofreading and editing services to ensure clarity and impact',
        docTypesTitle_4_details_5: 'Guidance on addressing specific prompts and questions',
        docTypesTitle_5: 'Medical and Police Clearance Reports',
        docTypesDesc_5: 'We help you obtain verified health and police clearance documents necessary for your visa approval.',
        docTypesTitle_5_details_1: 'Medical examination from embassy-approved clinics and hospitals',
        docTypesTitle_5_details_2: 'Vaccination records including COVID-19 and country-specific requirements',
        docTypesTitle_5_details_3: 'Police clearance certificate from local authorities and previous residences',
        docTypesTitle_5_details_4: 'Background verification and character certificates',
        docTypesTitle_5_details_5: 'TB test results and chest X-rays where applicable',
        certificateEligibility: 'Certificate of Eligibility (COE)',
        docTypesDesc_6: 'Guidance on preparing and submitting your COE for Japanese visa applications with complete accuracy.',
        docTypesTitle_6_details_1: 'Complete COE application form with accurate information',
        docTypesTitle_6_details_2: 'Supporting documents compiled according to immigration guidelines',
        docTypesTitle_6_details_3: 'Coordination with Japanese educational institutions for COE issuance',
        ...
        docTypesTitle_7_details_4: 'Passport-sized photographs meeting specific country requirements',
        docTypesTitle_7_details_5: 'Guidance on passport renewal or new issuance if necessary',
        ...
        accountingTraining: 'Accounting Training',
        graphicDesign: 'Graphic Design',
        videoEditing: 'Video Editing',
        advanceDiploma: 'Advance Diploma & Job Oriented Course',
        MSPowerPointCaption: 'Create Powerful Slides, Tell Impactful Stories',
        MSPowerPointTagline: 'From classrooms to boardrooms — PowerPoint skills that shine anywhere.',
        MSPaintCaption: 'Start Your Art Journey with Microsoft Paint.',
        MSPaintTagline: 'Bring Your Imagination to Life with MS Paint.',
        MSWordCaption: 'Boost Your Office Skills with Our MS Word Course.',
        MSWordTagline: 'From reports to resumes — create with confidence in MS Word.',
        MSExcelCaption: 'The Complete MS Excel Course for Students & Professionals.',
        MSExcelTagline: 'From formulas to dashboards — become an Excel powerhouse.',
        TypingMasterCaption: 'Boost Your Typing Speed and Accuracy.',
        TypingMasterTagline: 'Type faster, smarter, and confidently with Typing Master.',
        emailCaption: 'Professional Communication Starts with Email.',
        emailTagline: 'From Inbox to Impact — Master Professional Emailing.',
        adobeIndesignCaption: 'Design Smarter. Publish Better. Master InDesign.',
        adobeIndesignTagline: 'Turn your passion for design into real-world publishing skills.',
        adobePhotoshopCaption: 'Transform your photos and your career with Photoshop skills.',
        adobePhotoshopTagline: 'Design Stunning Graphics and Bring Your Ideas to Life.',
        canvaCapiton: 'Design Smarter, Faster, and Easier with Canva.',
        canvaTagline: 'From ideas to amazing designs — Start your Canva journey now!',
        tallyERP9Caption: 'Upgrade Your Accounting Skills with Practical Tally Training.',
        tallyERP9Tagline: 'Master Business Accounting with Tally ERP 9.',
        tallyPrimeCaption: 'Step-by-step Tally training for students, accountants, and business owners',
        tallyPrimeTagline: 'Simplify Accounting, Amplify Growth.',
        busyAccountingCaption: 'Professional Accounting Made Easy with Busy Accounting.',
        busyAccountingTagline: 'Perfect course for students, accountants, and business owners.',
        adobeIllustratorCaption: 'Learn Vector Design, Logo Creation & Digital Illustration with Illustrator.',
        adobeIllustratorTagline: 'Create Limitless Designs with Illustrator.',
        ...
        japanEducationalRequirementContent1: 'Completion of at least 12 years of formal education (high school level).',
        japanEducationalRequirementContent2: 'Official academic transcripts and certificates in English or Japanese.',
        japanEducationalRequirementContent3: 'JLPT N5 or above preferred; N3–N2 may be required for universities.',
        japanEducationalRequirementContent4: 'Some programs accept English-based courses depending on the institution.',
        japanFinancialRequirement: 'Financial Requirements',
        japanFinancialRequirementContent1: 'Proof of sufficient funds to cover tuition and living expenses.',
        japanFinancialRequirementContent2: 'A minimum balance of ¥1,000,000 is recommended in your/sponsor’s account.',
        japanFinancialRequirementContent3: 'Recent bank statements or certificates of deposit required.',
        japanFinancialRequirementContent4: 'Affidavit of financial support if sponsored by a parent or guardian.',
        japanOtherRequirement: 'Other Requirements',
        japanOtherRequirementContent1: 'Valid passport (minimum 1-year validity).',
        japanOtherRequirementContent2: 'Medical certificate confirming good health.',
        japanOtherRequirementContent3: 'Statement of Purpose explaining goals and motivation.',
        japanOtherRequirementContent4: 'Certificate of Eligibility (COE) from the Japanese institution.',
        japanCulturalRequirement: 'Cultural & Practical Preparation',
        japanCulturalRequirementContent1: 'Learn basic Japanese conversation and culture etiquette.',
        japanCulturalRequirementContent2: 'Understand part-time work regulations and housing options.',
        japanCulturalRequirementContent3: 'Attend orientation programs before departure.',
        japanWhyTitle: 'Why Choose Japan',
        japanWhyDesc: 'Japan blends world-class education, innovation, and a respectful work culture — making it a top destination for both students and professionals.',
        japanWhyBullets1: "World-class education and career opportunities in a globally respected nation.",
        japanWhyBullets2: "Scholarships and strong support systems for international students.",
        japanWhyBullets3: "Highly innovative, technology-driven environment fostering creativity and research.",
        japanWhyBullets4: "Safe, clean, and well-organized society ideal for both study and work.",
        japanWhyBullets5: "High living standards with excellent infrastructure and healthcare.",
        japanWhyBullets6: "Respectful, disciplined, and teamwork-oriented work culture.",
        japanWhyBullets7: "Smooth transition from student life to long-term career opportunities.",
        japanWhyBullets8: "Rich cultural heritage blended with modern global exposure.",
        japanWhyBullets9: "Opportunities to learn Japanese and strengthen global employability.",
        japanWhyBullets10: "Government initiatives supporting international students and skilled professionals.",
        ...
        studyTestDuration_2: '2 hours',
        studyTestWhyNeeded_2: `PTE Academic uses AI technology for unbiased scoring and delivers results within 48 hours. It's recognized by thousands of institutions globally and is ideal for those seeking quick turnaround times.`,
        studyTestBachelorScore_2: '50 - 58 overall (with communicative skills at 50+)',
        studyTestMasterScore_2: '58 - 65 overall (with communicative skills at 58+)',
        studyTestDiplomaScore_2: '42 - 50 overall (with communicative skills at 42+)',
        studyTestsFormat_2: 'Computer-based only',
        studyTestsDesc_3: 'The Test of English as a Foreign Language (TOEFL) measures English proficiency for academic purposes, accepted by over 11,000 universities worldwide.',
        academicEnglish: 'Academic English',
        globalRecognition: 'Global Recognition',
        onlineTest: 'Online Test',
        studyTestsWhyNeeded_3: `TOEFL is specifically designed for academic English and is the preferred test for North American universities. It assesses your ability to understand and use English in university settings.`,
        studyTestBachelorScore_3: '70 - 80 overall (with section scores 17+)',
        studyTestMasterScore_3: '85 - 100 overall (with section scores 20+)',
        ...
        fiveYear: '5 years',
        studyTestsWhyNeeded_4: `The SAT is a standardized test for college admissions in the US. High scores can qualify you for merit-based scholarships and demonstrate readiness for college-level coursework.`,
        ...
        osakaUniversity: 'Osaka University',
        tohokuUniversity: 'Tohoku University',
        nagoyaUniversity: 'Nagoya University',
        kyushuUniversity: 'Kyushu University',
        hokkaidoUniversity: 'Hokkaido University',
        keioUniversity: 'Keio University',
        wasedaUniversity: 'Waseda University',
        ...
        CIHE: 'CIHE',
        monashUniversity: 'Monash University',
        universityTasmania: ' University of Tasmania',
        universitySydney: 'University of Sydney',
        univesityMelbourne: 'University of Melbourne',
        ukHeroDesc: `Experience prestigious education in the UK, rich history, and global networks. Study in the UK develops personal growth, professional skills, and international exposure.`,
        UKRequirementTitle: 'Requirement to Study in the UK',
        UKRequirementSubTitle: `Find out what you need to apply for your Australian student visa and start your studies in one of the world's best education systems.`,
        UKRequirementContent1: "Completion of at least 12 years of formal education (equivalent to UK A-levels or International Baccalaureate).",
        UKRequirementContent2: "Certified copies of academic transcripts and certificates in English.",
        UKRequirementContent3: "For higher education, submission of English proficiency scores (IELTS, TOEFL, or PTE Academic).",
        UKRequirementContent4: "Universities may have specific entry requirements—check individual course prerequisites before applying.",
        UKFinancialRequirementContent1: "Proof of sufficient funds to cover tuition fees, accommodation, and living expenses.",
        UKFinancialRequirementContent2: "Estimated living cost: at least £1,334 per month in London or £1,023 per month outside London (for up to 9 months).",
        UKFinancialRequirementContent3: "Acceptable proof includes bank statements, sponsor letters, or financial guarantee documents.",
        UKFinancialRequirementContent4: "Sponsored or scholarship students must provide an official confirmation letter from the sponsor or funding body.",
        UKVisaDocumentationContent1: "Valid passport with at least 6 months of remaining validity.",
        UKVisaDocumentationContent2: "Confirmation of Acceptance for Studies (CAS) issued by a licensed UK institution.",
        UKVisaDocumentationContent3: "Completed Student Visa (formerly Tier 4) application and payment of the Immigration Health Surcharge (IHS).",
        UKVisaDocumentationContent4: "Proof of English language proficiency and financial evidence as per UKVI guidelines.",
        UKVisaDocumentationContent5: "Medical test (tuberculosis clearance) may be required depending on country of residence.",
        UKCulturalPracticalPreparationContent1: "Familiarize yourself with the UK’s academic culture focused on independent study and critical thinking.",
        UKCulturalPracticalPreparationContent2: "Understand student work rights—up to 20 hours per week during term time and full-time during holidays.",
        UKCulturalPracticalPreparationContent3: "Research accommodation options such as university halls, private housing, or homestays.",
        UKCulturalPracticalPreparationContent4: "Learn about public transport systems, NHS healthcare registration, and emergency services before arrival.",
        whyChooseUKTitle: 'Why Choose the UK 🇬🇧',
        whyChooseUKDesc: 'The UK is a top destination for higher education and international careers, offering world-class universities, rich culture, and excellent global exposure.',
        UKWhyReason1: "Home to some of the world’s oldest and most prestigious universities.",
        UKWhyReason2: "High-quality education recognized globally across multiple disciplines.",
        UKWhyReason3: "Vibrant international student community from all over the world.",
        UKWhyReason4: "Opportunities for part-time work and internships during studies.",
        UKWhyReason5: "Post-study work visa allowing graduates to gain professional experience.",
        UKWhyReason6: "Rich cultural heritage and modern cities providing a dynamic lifestyle.",
        UKWhyReason7: "Strong research opportunities and access to cutting-edge facilities.",
        UKWhyReason8: "Safe and supportive environment for international students.",
        UKWhyReason9: "Financial support and scholarships for deserving students.",
        UKWhyReason10: "Excellent networking opportunities and global career prospects.",
        ...
        UniversityofManchester: 'University of Manchester',
        UniversityofGlasgow: 'University of Glasgow',
        KingsCollegeLondon: "King's College London",
        UniversityofWarwick: 'University of Warwick',
        usHeroDesc: `Experience world-class education in the USA with cutting-edge technology, diverse culture, and endless opportunities. Study in the USA enhances personal growth and career prospects.`,
        usRequirementTitle: 'Requirement to Study in the USA 🇺🇸',
        usRequirementSubTitle: `Find out what you need to apply for your Australian student visa and start your studies in one of the world's best education systems.`,
        USRequirementContent1: "Completion of at least 12 years of formal education (equivalent to U.S. high school diploma).",
        USRequirementContent2: "Certified copies of academic transcripts and certificates in English.",
        USRequirementContent3: "Submission of standardized test scores if required (SAT, ACT, GRE, or GMAT depending on program).",
        USRequirementContent4: "Proof of English proficiency through IELTS, TOEFL, or Duolingo English Test for international students.",
        USRequirementContent5: "Each institution may have specific academic and program prerequisites—verify before applying.",
        USFinancialRequirementContent1: "Proof of sufficient financial resources to cover tuition, living expenses, and travel costs.",
        USFinancialRequirementContent2: "Estimated annual living cost ranges from USD 10,000–18,000, excluding tuition fees.",
        USFinancialRequirementContent3: "Acceptable documents include recent bank statements, sponsor letters, or Form I-134 (Affidavit of Support).",
        USFinancialRequirementContent4: "Scholarship or assistantship recipients must submit official award or funding confirmation letters.",
        USVisaDocumentationContent1: "Valid passport with at least 6 months of validity beyond intended stay.",
        USVisaDocumentationContent2: "Form I-20 issued by a SEVP-approved U.S. institution for F-1 visa applicants.",
        USVisaDocumentationContent3: "Completed DS-160 visa application form and SEVIS fee payment receipt.",
        USVisaDocumentationContent4: "Proof of financial ability, academic transcripts, and admission letter at the visa interview.",
        USVisaDocumentationContent5: "Medical records, vaccination proof, and police clearance may be required in some cases.",
        USCulturalPracticalPreparationContent1: "Understand the U.S. academic culture emphasizing critical thinking and participation.",
        USCulturalPracticalPreparationContent1: "Familiarize yourself with U.S. classroom culture, which values participation and critical thinking.",
        USCulturalPracticalPreparationContent2: "Understand student work rights—on-campus work allowed up to 20 hours per week during semesters.",
        USCulturalPracticalPreparationContent3: "Explore accommodation options including dormitories, shared apartments, or homestays.",
        USCulturalPracticalPreparationContent4: "Learn about local transportation, healthcare (student insurance plans), and emergency services before arrival.",
        whyChooseUSTitle: 'Why Choose the US 🇺🇸',
        UsWhyDesc: 'The United States provides excellent education, professional opportunities, and global recognition — making it ideal for ambitious students and professionals.',
        USWhyReason1: "Home to globally ranked universities and top research institutions.",
        USWhyReason2: "Wide variety of courses and flexible learning programs.",
        USWhyReason3: "Innovative and technology-driven environment for students and professionals.",
        USWhyReason4: "Part-time work and internship opportunities during studies.",
        USWhyReason5: "Strong post-graduation employment prospects with STEM OPT programs.",
        USWhyReason6: "Diverse and multicultural society welcoming international students.",
        USWhyReason7: "High-quality infrastructure and world-class campus facilities.",
        USWhyReason8: "Abundant scholarship and financial aid opportunities.",
        USWhyReason9: "Vibrant student life with cultural, social, and networking opportunities.",
        USWhyReason10: "Global recognition of US degrees boosting career prospects worldwide.",
        ...
        cadHeroDesc: 'Experience high-quality education in Canada with multicultural environments and advanced facilities. Study in Canada supports personal growth, career advancement, and global opportunities.',
        cadRequirementTitle: 'Requirements to Study in Canada 🇨🇦',
        cadRequirementSubTitle: `Find out what you need to apply for your Australian student visa and start your studies in one of the world's best education systems.`,
        cadRequirementContent1: "Completion of at least 12 years of formal education (equivalent to Canadian high school diploma).",
        cadRequirementContent2: "Certified copies of academic transcripts and certificates translated into English or French.",
        cadRequirementContent3: "For post-secondary or graduate programs, submission of English or French language proficiency scores (IELTS, TOEFL, or TEF).",
        cadRequirementContent4: "Each college or university may have specific academic entry requirements—check course prerequisites before applying.",
        cadFinancialRequirementContent1: "Proof of sufficient funds to cover tuition, living expenses, and return transportation.",
        cadFinancialRequirementContent2: "Minimum financial requirement: CAD 20,635 per year (outside Quebec) or as per IRCC guidelines.",
        cadFinancialRequirementContent3: "Acceptable proof includes recent bank statements, GIC (Guaranteed Investment Certificate), or sponsor letters.",
        cadFinancialRequirementContent4: "Sponsored or scholarship students must provide official documentation confirming financial support.",
        cadVisaDocumentationContent1: "Valid passport with at least 6 months of remaining validity.",
        cadVisaDocumentationContent2: "Letter of Acceptance (LOA) from a Designated Learning Institution (DLI) in Canada.",
        cadVisaDocumentationContent3: "Completed Study Permit application with Statement of Purpose (SOP).",
        cadVisaDocumentationContent4: "Proof of payment for tuition fees and GIC (if applicable).",
        cadVisaDocumentationContent5: "Medical examination and police clearance certificates may be required depending on country of residence.",
        cadCulturalPreparationContent1: "Familiarize yourself with Canada’s multicultural and inclusive academic environment.",
        cadCulturalPreparationContent2: "Understand student work rights—up to 20 hours per week during study and full-time during scheduled breaks.",
        cadCulturalPreparationContent3: "Research accommodation options such as on-campus housing, homestay, or private rentals.",
        cadCulturalPreparationContent4: "Learn about public transport, healthcare (e.g., provincial health insurance), and emergency contacts before arrival.",
        WhyChooseCanada: 'Why Choose Canada 🇨🇦',
        cadWhyDesc: `Canada is known for its top-quality education, safe environment, and excellent career opportunities, making it a top choice for international students.`,
        cadWhyCanadaReason1: "High-quality education with internationally recognized degrees.",
        cadWhyCanadaReason2: "Welcoming, multicultural society with a safe environment for students.",
        cadWhyCanadaReason3: "Opportunities for part-time work during studies to gain experience.",
        cadWhyCanadaReason4: "Post-graduation work permits and pathways to permanent residency.",
        cadWhyCanadaReason5: "Vibrant student communities with cultural and recreational activities.",
        cadWhyCanadaReason6: "Modern infrastructure, advanced research facilities, and technology-driven learning.",
        cadWhyCanadaReason7: "Generous scholarships and financial support options for international students.",
        cadWhyCanadaReason8: "Strong economy with demand for skilled graduates across multiple industries.",
        cadWhyCanadaReason9: "Beautiful natural landscapes and high quality of life.",
        cadWhyCanadaReason10: "Supportive policies for international students, including healthcare and housing assistance.",
    ...
    jp: {
        ...
        selectYourUniversity: '希望する大学を選択してください...',
        USA: 'アメリカ合衆国（USA）',
        UK: 'イギリス（UK）',
        canada: 'カナダ',
        japan: '日本',
        ...
        uniSelListDesc: `世界中の名門大学ネットワークを探索し、信頼できる提携校の中からあなたの夢の教育機関を見つけましょう。`,
        searchUniversities: `大学を検索...`,
        allCountries: 'すべての国',
        tokyoUniversity: '東京大学',
        tokyoJapan: '日本、東京',
        kyotoUniversity: '京都大学',
        kyotoJapan: '日本、京都',
        harvardUniversity: 'ハーバード大学',
        cambridgeMassachusetts: 'マサチューセッツ州ケンブリッジ',
        stanfordUniversity: 'スタンフォード大学',
        stanfordCalifornia: 'カリフォルニア州スタンフォード',
        universityOxford: 'オックスフォード大学',
        oxfordEngland: 'イングランド、オックスフォード',
        universityCambridge: 'ケンブリッジ大学',
        cambridgeEngland: 'イングランド、ケンブリッジ',
        universityToronto: 'トロント大学',
        torontoOntario: 'オンタリオ州トロント',
        universityBritishColumbia: 'ブリティッシュコロンビア大学',
        vancouverBC: 'ブリティッシュコロンビア州バンクーバー',
        universityMelbourne: 'メルボルン大学',
        melbourneVictoria: 'ビクトリア州メルボルン',
        ...
        docTypesHeader: 'サポート対象の書類',
        docTypesDesc: `書類準備のすべてのステップでサポートし、規定の遵守、正確性、大使館承認を確実にします。専門チームが、書類を完全かつ専門的に整えます。`,
        docTypesTitle_1: '成績証明書・修了証明書',
        docTypesDesc_1: `大学や大使館の要件を満たすために、学歴記録の整理と確認をサポートします。`,
        docTypesTitle_1_details_1: '在籍したすべての教育機関の学位証明書および成績表',
        docTypesTitle_1_details_2: '正式な成績証明書（適切な認証・証明付き）',
        docTypesTitle_1_details_3: '国際資格の認定評価報告書',
        docTypesTitle_1_details_4: '渡航先の国が求める場合の成績換算書類',
        docTypesTitle_2: '語学能力証明書（IELTS、JLPT、TOEFL）',
        docTypesDesc_2: `選択した国で必要な有効な語学証明書の取得と提出を、当社チームがサポートします。`,
        docTypesTitle_2_details_1: '英語圏向けのIELTS（最低バンド要件は異なる）',
        docTypesTitle_2_details_2: '日本語プログラム・大学向けのJLPT（N5〜N1）',
        docTypesTitle_2_details_3: '米国・カナダの教育機関向けTOEFL iBT',
        docTypesTitle_2_details_4: 'PTE、Duolingo英語テスト、または各機関独自の試験などのその他の認定テスト',
        docTypesDesc_3: 'スポンサーからの証明書や銀行明細まで、公式の形式と基準に沿った財務証明を確実に整えます。',
        docTypesTitle_3_details_1: '十分な資金を示す、6～12か月分の銀行取引明細書',
        docTypesTitle_3_details_2: '保護者または親からのスポンサー証明書（収入証明付き）',
        docTypesTitle_3_details_3: '不動産書類、定期預金、または投資証明書',
        docTypesTitle_3_details_4: '奨学金授与通知書または経済援助の書類',
        docTypesTitle_3_details_5: 'スポンサーの確定申告書および在職証明書',
        docTypesTitle_4: '志望理由書（SOP）および推薦状',
        docTypesDesc_4: '強力なSOPとプロフェッショナルな推薦状の作成を専門家がサポートし、あなたの申請を強化します。',
        docTypesTitle_4_details_1: '学業目標やキャリア志向を強調した、個別対応のSOP',
        docTypesTitle_4_details_2: '教授や雇用主からの推薦状2～3通',
        docTypesTitle_4_details_3: '大学およびビザの要件に沿った形式の推薦状',
        docTypesTitle_4_details_4: '明確さと効果を高めるための校正・編集サービス',
        docTypesTitle_4_details_5: '特定の課題や質問への対応に関する指導',
        docTypesTitle_5: '医療証明書および無犯罪証明書',
        docTypesDesc_5: 'ビザ承認に必要な、認証済みの健康証明書や無犯罪証明書の取得をサポートします。',
        docTypesTitle_5_details_1: '大使館承認のクリニックや病院での健康診断',
        docTypesTitle_5_details_2: 'ワクチン接種記録（COVID-19および各国の要件を含む）',
        docTypesTitle_5_details_3: '現地当局および過去の居住地からの無犯罪証明書',
        docTypesTitle_5_details_4: '身元確認および身辺証明書',
        ...
        docTypesTitle_7_details_2: 'すべての書類における個人情報の正確性の確認',
        docTypesTitle_7_details_3: '国民IDカード、出生証明書、および市民権証明書',
        docTypesTitle_7_details_4: '各国の要件に適合したパスポートサイズの写真',
        docTypesTitle_7_details_5: '必要に応じたパスポートの更新や新規発行に関する指導',
        ...
        videoEditing: 'ビデオ編集',
        advanceDiploma: '上級ディプロマ＆就職志向コース',
        MSPowerPointCaption: '強力なスライドを作成し、印象的なストーリーを伝える',
        MSPowerPointTagline: '教室から会議室まで、どこでも活かせるパワーポイントスキル。',
        MSPaintCaption: 'Microsoft Paintでアートの旅を始めよう。',
        MSPaintTagline: 'MS Paintで想像力を形にしよう。',
        MSWordCaption: '当社のMSワードコースでオフィススキルを向上させよう。',
        MSWordTagline: 'レポートから履歴書まで、MSワードで自信を持って作成しよう。',
        MSExcelCaption: '学生とプロ向けの完全なMSエクセルコース。',
        MSExcelTagline: '数式からダッシュボードまで、Excelの達人になろう。',
        TypingMasterCaption: 'タイピング速度と正確さを向上させよう。',
        TypingMasterTagline: 'Typing Masterで、速く、正確に、自信を持ってタイピングしよう。',
        emailCaption: 'プロフェッショナルなコミュニケーションはEメールから始まる。',
        ...
        tallyERP9Tagline: 'Tally ERP 9でビジネス会計をマスターしよう。',
        tallyPrimeCaption: '学生、会計士、ビジネスオーナー向けのステップごとのTallyトレーニング',
        tallyPrimeTagline: '会計を簡単にし、成長を加速させよう。',
        busyAccountingCaption: 'Busy Accountingでプロの会計を簡単に。',
        busyAccountingTagline: '学生、会計士、ビジネスオーナーに最適なコース。',
        adobeIllustratorCaption: 'Illustratorでベクターデザイン、ロゴ作成、デジタルイラストを学ぼう。',
        adobeIllustratorTagline: 'Illustratorで無限のデザインを作ろう。',
        ...
        japanEducationalRequirement: '学歴要件',
        japanEducationalRequirementContent1: '少なくとも12年間の正規教育（高等学校レベル）を修了していること。',
        japanEducationalRequirementContent2: '英語または日本語で書かれた公式の成績証明書と証明書。',
        japanEducationalRequirementContent3: 'JLPT N5以上が望ましい。大学ではN3～N2が必要になる場合があります。',
        japanEducationalRequirementContent4: '一部のプログラムでは、教育機関に応じて英語ベースのコースを受け入れています。',
        japanFinancialRequirement: '経済的要件',
        japanFinancialRequirementContent1: '授業料と生活費を賄うのに十分な資金があることの証明。',
        japanFinancialRequirementContent2: 'あなた/スポンサーのアカウントには最低1,000,000円の残高があることが推奨されます。',
        japanFinancialRequirementContent3: '最近の銀行取引明細書または預金証書が必要です。',
        japanFinancialRequirementContent4: '親または保護者が後援している場合は、財政支援の宣誓供述書。',
        japanOtherRequirement: 'その他の要件',
        japanOtherRequirementContent1: '有効なパスポート（有効期間が最低1年）。',
        japanOtherRequirementContent2: '健康状態を証明する医師の診断書。',
        japanOtherRequirementContent3: '目標と動機を説明する目的の声明。',
        japanOtherRequirementContent4: '日本の教育機関が発行する在留資格認定証明書（COE）。',
        japanCulturalRequirement: '文化と実践の準備',
        japanCulturalRequirementContent1: '基本的な日本語会話と文化の礼儀作法を学びます。',
        japanCulturalRequirementContent2: 'パートタイム労働の規制と住宅オプションを理解します。',
        japanCulturalRequirementContent3: '出発前にオリエンテーション プログラムに参加してください。',
        japanWhyTitle: '日本を選ぶ理由',
        japanWhyDesc: '日本は世界クラスの教育、イノベーション、そして敬意ある労働文化を融合しており、学生と専門家の両方にとって最高の留学先となっています。',
        japanWhyBullets1: '世界的に尊敬される国での世界クラスの教育とキャリアの機会。',
        japanWhyBullets2: '留学生のための奨学金と強力なサポートシステム。',
        japanWhyBullets3: '創造性と研究を促進する、革新的でテクノロジー主導の環境。',
        japanWhyBullets4: '安全で清潔、そして秩序立った社会は勉強にも仕事にも最適です。',
        japanWhyBullets5: '優れたインフラと医療による高い生活水準。',
        japanWhyBullets6: '敬意、規律、チームワークを重視する職場文化。',
        japanWhyBullets7: '学生生活から長期的なキャリア機会へのスムーズな移行。',
        japanWhyBullets8: '豊かな文化遺産と現代のグローバルな露出が融合しています。',
        japanWhyBullets9: 'Opportunities to learn Japanese and strengthen global employability.',
        japanWhyBullets10: '留学生と熟練した専門家を支援する政府の取り組み。',
        ...
        studyTestsFormat_2: 'コンピュータベースのみ',
        studyTestsDesc_3: 'TOEFL (Test of English as a Foreign Language) は、学術目的の英語能力を測定するテストで、世界中の 11,000 以上の大学で認められています。',
        academicEnglish: 'アカデミック英語',
        globalRecognition: '世界的に認められる',
        onlineTest: 'オンラインテスト',
        studyTestsWhyNeeded_3: 'TOEFLはアカデミック英語に特化したテストで、北米の大学で推奨されています。大学での英語の理解力と運用能力を評価します。',
        studyTestBachelorScore_3: '総合点70～80点（セクションスコア17点以上）',
        studyTestMasterScore_3: '総合点85～100点（セクションスコア20点以上）',
        studyTestDiplomaScore_3: '総合点60～70点（セクションスコア15点以上）',
        studyTestsFormat_3: 'インターネットベース（iBT）または紙ベース',
        studyTestsDesc_4: 'SAT（Scholastic Assessment Test）は数学、読解、文章作成能力を評価するもので、多くの米国の大学で重要な要件となっています。',
        mathEnglish: '数学と英語',
        ...
        studyTestsFormat_4: '紙ベースまたはデジタル',
        studyTestsDesc_5: '日本語能力試験（JLPT）は、初級（N5）から上級（N1）までの非ネイティブスピーカーの日本語能力を評価するもので、日本での学習や仕事に不可欠です。',
        fiveLevels: '5つのレベル',
        languageProficiency: '言語能力',
        studyWorkInJapan: '日本での学習と仕事',
        studyTestDuration_5: '105～170分（レベルによって異なります）',
        noExpiration: '有効期限なし',
        studyTestsWhyNeeded_5: '日本語能力試験（JLPT）は、日本での大学入学、就職、ビザ申請に必須の資格です。基本的なコミュニケーション能力からビジネスレベルの流暢さまで、日本語能力を証明します。',
        studyTestBachelorScore_5: 'N2レベル（スコア90+/180） - 中上級',
        studyTestMasterScore_5: 'N1レベル（スコア100+/180） - 上級',
        studyTestDiplomaScore_5: 'N3レベル（スコア95+/180） - 中級',
        studyTestsFormat_5: '筆記試験と聴解試験',
        popularStudyTests: '人気の学習テスト',
        studyTestsMainDesc: '一流大学や国際的なキャリアのチャンスへの扉を開く、世界的に認められたテストの準備をしましょう。',
        whyIs: 'なぜですか',
        needed: '必要なのか',
        testFormat: 'テスト形式',
        requiredScoresHeader: 'プログラムレベル別の必要スコア',
        degree: '程度',
        ...
        osakaUniversity: '大阪大学',
        nagoyaUniversity: '名古屋大学',
        tohokuUniversity: '東北大学',
        kyushuUniversity: '九州大学',
        hokkaidoUniversity: '北海道大学',
        keioUniversity: '慶應義塾大学',
        WasedaUniversity: '早稲田大学',
        ...
        CIHEL: 'シヘル',
        monashUniversity: 'モナシュ大学',
        universityTasmania: 'タスマニア大学',
        universitySydney: 'シドニー大学',
        universityMelbourne: 'メルボルン大学',
        ukHeroDesc: `英国の名門教育、豊かな歴史、そしてグローバルネットワークを体験してください。英国での留学は、個人の成長、専門スキル、そして国際的な経験を育みます。`,
        ukRequirementTitle: '英国留学の要件',
        UKRequirementSubTitle: `オーストラリアの学生ビザを申請するために必要なものを確認し、世界最高峰の教育システムのひとつで勉強を始めましょう。`,
        UKRequirementContent1: "少なくとも12年間の正規教育を修了していること（英国のAレベルまたは国際バカロレアに相当）。",
        UKRequirementContent2: "英語で記載された学業成績証明書および修了証明書の認定コピーを提出すること。",
        UKRequirementContent3: "高等教育を志望する場合は、英語能力試験（IELTS、TOEFL、またはPTE Academic）のスコアを提出すること。",
        UKRequirementContent4: "大学によっては特定の入学要件があるため、出願前に各コースの条件を確認すること。",
        UKFinancialRequirementContent1: "授業料、宿泊費、生活費を賄うのに十分な資金があることの証明。",
        UKFinancialRequirementContent2: "推定生活費：ロンドンでは月額少なくとも£1,334、ロンドン以外では月額£1,023（最長9か月分）。",
        UKFinancialRequirementContent3: "認められる証明書類には、銀行の残高証明書、スポンサーからのレター、または財政保証書などがあります。",
        UKFinancialRequirementContent4: "スポンサーや奨学金を受けている学生は、スポンサーまたは資金提供機関からの正式な確認書を提出する必要があります。",
        UKVisaDocumentationContent1: "有効期限が少なくとも6か月以上残っている有効なパスポート。",
        UKVisaDocumentationContent2: "英国の認可教育機関が発行する入学許可書（CAS：Confirmation of Acceptance for Studies）。",
        UKVisaDocumentationContent3: "学生ビザ（旧Tier 4）申請書の提出および移民医療付加料（IHS）の支払い。",
        UKVisaDocumentationContent4: "UKVIのガイドラインに従った英語能力証明および財政証明書類。",
        UKVisaDocumentationContent5: "居住国によっては、結核検査（TBクリアランス）の提出が必要となる場合があります。",
        UKCulturalPracticalPreparationContent1: "自主学習と批判的思考を重視する英国の学問文化に慣れましょう。",
        UKCulturalPracticalPreparationContent2: "学生の就労権を理解しましょう—学期中は週20時間まで、休暇中はフルタイムで働くことができます。",
        UKCulturalPracticalPreparationContent3: "大学寮、民間住宅、ホームステイなどの宿泊オプションを調べましょう。",
        UKCulturalPracticalPreparationContent4: "到着前に、公共交通機関の利用方法、NHS（国民保健サービス）への登録、緊急サービスについて学びましょう。",
        whyChooseUKTitle: 'なぜ英国を選ぶのか🇬🇧',
        whyChooseUKDesc: '英国は、世界クラスの大学、豊かな文化、優れた国際的経験を提供しており、高等教育と国際的なキャリアにとって最高の目的地です。',
        UKWhyReason1: "世界で最も古く、最も名高い大学のいくつかが存在します。",
        UKWhyReason2: "複数の分野で世界的に認められた高品質な教育。",
        UKWhyReason3: "世界中から集まる活気ある国際学生コミュニティ。",
        UKWhyReason4: "学業中にパートタイム就労やインターンシップの機会があります。",
        UKWhyReason5: "卒業後の就労ビザにより、専門的な経験を積むことができます。",
        UKWhyReason6: "豊かな文化遺産と現代的な都市が提供するダイナミックなライフスタイル。",
        UKWhyReason7: "最先端施設へのアクセスと強力な研究機会。",
        UKWhyReason8: "国際学生にとって安全で支援的な環境。",
        UKWhyReason9: "優秀な学生のための奨学金や経済的支援。",
        UKWhyReason10: "優れたネットワーキング機会とグローバルなキャリア展望。",
        imperialCollegeLondon: 'インペリアル・カレッジ・ロンドン',
        LondonSchoolofEconomicsandPoliticalScience: 'ロンドン・スクール・オブ・エコノミクス',
        UniversityCollegeLondon: 'ユニバーシティ・カレッジ・ロンドン',
        UniversityofEdinburgh: 'エディンバラ大学',
        UniversityofManchester: 'マンチェスター大学',
        UniversityofGlasgow: 'グラスゴー大学',
        KingsCollegeLondon: 'キングス・カレッジ・ロンドン',
        UniversityofWarwick: 'ウォーリック大学',
        usHeroDesc: '最先端のテクノロジー、多様な文化、そして無限の可能性を秘めたアメリカで、世界クラスの教育を体験してください。アメリカ留学は、個人の成長とキャリアの可能性を広げます。',
        usRequirementTitle: 'アメリカ留学の要件 🇺🇸',
        usRequirementSubTitle: 'オーストラリアの学生ビザを申請するために必要なものを確認し、世界最高峰の教育システムのひとつで勉強を始めましょう。',
        USRequirementContent1: "少なくとも12年間の正規教育を修了していること（米国の高等学校卒業証書に相当）。",
        USRequirementContent2: "英語で記載された学業成績証明書および修了証明書の認定コピーを提出すること。",
        USRequirementContent3: "必要に応じて標準化試験のスコアを提出すること（プログラムに応じてSAT、ACT、GRE、またはGMAT）。",
        USRequirementContent4: "国際学生の場合、IELTS、TOEFL、またはDuolingo English Testによる英語能力証明が必要。",
        USRequirementContent5: "各教育機関には特定の学術およびプログラムの前提条件がある場合があるため、出願前に確認してください。",
        USFinancialRequirementContent1: "授業料、生活費、渡航費を賄うのに十分な資金の証明。",
        USFinancialRequirementContent2: "年間の推定生活費は授業料を除きUSD 10,000〜18,000の範囲。",
        USFinancialRequirementContent3: "認められる書類には、最新の銀行残高証明書、スポンサーからのレター、またはフォームI-134（支援誓約書）などがあります。",
        USFinancialRequirementContent4: "奨学金や助手職を受ける学生は、公式の受給証明書または資金確認書を提出する必要があります。",
        USVisaDocumentationContent1: "滞在予定期間を超えて少なくとも6か月の有効期限がある有効なパスポート。",
        USVisaDocumentationContent2: "F-1ビザ申請者向けにSEVP認定の米国教育機関が発行したフォームI-20。",
        USVisaDocumentationContent3: "DS-160ビザ申請書の記入およびSEVIS料金の支払い領収書。",
        USVisaDocumentationContent4: "ビザ面接時に、財政能力の証明、学業成績証明書、入学許可書を提示。",
        USVisaDocumentationContent5: "場合によっては、医療記録、予防接種証明、警察証明書の提出が必要となる場合があります。",
        USCulturalPracticalPreparationContent1: "参加型と批判的思考を重視する米国の教室文化に慣れましょう。",
        USCulturalPracticalPreparationContent2: "学生の就労権を理解しましょう—学期中はキャンパス内で週20時間まで働くことができます。",
        USCulturalPracticalPreparationContent3: "寮、シェアアパート、ホームステイなどの宿泊オプションを調べましょう。",
        USCulturalPracticalPreparationContent4: "到着前に、現地の交通機関、医療（学生保険プラン）、および緊急サービスについて学びましょう。",
        whyChooseUSTitle: 'なぜアメリカを選ぶのか🇺🇸',
        UsWhyDesc: 'アメリカは優れた教育、職業上の機会、そして世界的な認知度を提供しており、意欲的な学生や専門家にとって理想的な国です。',
        USWhyReason1: "世界的にランク付けされた大学やトップの研究機関があります。",
        USWhyReason2: "幅広いコースと柔軟な学習プログラム。",
        USWhyReason3: "学生や専門職向けの革新的でテクノロジー主導の環境。",
        USWhyReason4: "学業中のパートタイム就労やインターンシップの機会。",
        USWhyReason5: "STEM OPTプログラムによる卒業後の強力な就職見通し。",
        USWhyReason6: "国際学生を歓迎する多様で多文化な社会。",
        USWhyReason7: "高品質なインフラと世界クラスのキャンパス施設。",
        USWhyReason8: "豊富な奨学金および経済的支援の機会。",
        USWhyReason9: "文化・社会・ネットワーキングの機会に富んだ活気ある学生生活。",
        USWhyReason10: "米国の学位は世界的に認知され、キャリアの可能性を広げます。",
        MIT: 'マサチューセッツ工科大学（MIT）',
        UniversityofCaliforniaBerkeley: 'カリフォルニア大学バークレー校',
        ColumbiaUniversity: 'コロンビア大学',
        UniversityofChicago: 'シカゴ大学',
        YaleUniversity: 'イェール大学',
        PrincetonUniversity: 'プリンストン大学',
        UniversityofMichigan: 'ミシガン大学',
        NewYorkUniversity: 'ニューヨーク大学',
        cadHeroDesc: '多文化環境と先進的な設備を備えたカナダで、質の高い教育を体験してください。カナダでの留学は、個人の成長、キャリアアップ、そしてグローバルな機会を支えます。',
        cadRequirementTitle: 'カナダ留学の要件 🇨🇦',
        cadRequirementSubTitle: 'オーストラリアの学生ビザを申請するために必要なものを確認し、世界最高峰の教育システムのひとつで勉強を始めましょう。',
        cadRequirementContent1: "少なくとも12年間の正規教育を修了していること（カナダの高等学校卒業証書に相当）。",
        cadRequirementContent2: "英語またはフランス語に翻訳された学業成績証明書および修了証明書の認定コピー。",
        cadRequirementContent3: "高等教育または大学院プログラムの場合、英語またはフランス語の能力試験スコア（IELTS、TOEFL、またはTEF）の提出。",
        cadRequirementContent4: "各大学やカレッジには特定の学術入学要件がある場合があるため、出願前にコースの前提条件を確認してください。",
        cadFinancialRequirementContent1: "授業料、生活費、帰国費用を賄うのに十分な資金の証明。",
        cadFinancialRequirementContent2: "最低資金要件：年間CAD 20,635（ケベック州以外）またはIRCCのガイドラインに従う。",
        cadFinancialRequirementContent3: "認められる証明書類には、最新の銀行残高証明書、GIC（保証投資証書）、またはスポンサーからのレターなどがあります。",
        cadFinancialRequirementContent4: "スポンサーや奨学金を受けている学生は、資金支援を確認する公式書類を提出する必要があります。",
        cadVisaDocumentationContent1: "残存有効期限が少なくとも6か月以上ある有効なパスポート。",
        cadVisaDocumentationContent2: "カナダの指定学習機関（DLI）からの入学許可書（LOA）。",
        cadVisaDocumentationContent3: "目的声明書（SOP）を添付した学習許可証（Study Permit）申請書の提出。",
        cadVisaDocumentationContent4: "授業料およびGIC（該当する場合）の支払い証明。",
        cadVisaDocumentationContent5: "居住国によっては、医療検査および警察証明書の提出が必要な場合があります。",
        cadCulturalPreparationContent1: "カナダの多文化的で包摂的な学習環境に慣れましょう。",
        cadCulturalPreparationContent2: "学生の就労権を理解しましょう—学期中は週20時間まで、休暇中はフルタイムで働くことができます。",
        cadCulturalPreparationContent3: "キャンパス内の宿舎、ホームステイ、民間賃貸などの宿泊オプションを調べましょう。",
        cadCulturalPreparationContent4: "到着前に、公共交通機関、医療（州の健康保険など）、緊急連絡先について学びましょう。",
        WhyChooseCanada: 'カナダを選ぶ理由🇨🇦',
        cadWhyDesc: `カナダは、質の高い教育、安全な環境、優れた就職機会で知られており、留学生にとって最適な選択肢となっています。`,
        cadWhyCanadaReason1: "国際的に認められた学位を提供する高品質な教育。",
        cadWhyCanadaReason2: "学生にとって安全で、多文化的な歓迎社会。",
        cadWhyCanadaReason3: "学業中に経験を積むためのパートタイム就労の機会。",
        cadWhyCanadaReason4: "卒業後の就労許可と永住権取得への道。",
        cadWhyCanadaReason5: "文化的・レクリエーション活動が豊富な活気ある学生コミュニティ。",
        cadWhyCanadaReason6: "現代的なインフラ、先進的な研究施設、技術主導の学習環境。",
        cadWhyCanadaReason7: "国際学生向けの奨学金や経済的支援が充実。",
        cadWhyCanadaReason8: "複数の産業で熟練卒業生の需要がある強固な経済基盤。",
        cadWhyCanadaReason9: "美しい自然景観と高い生活水準。",
        cadWhyCanadaReason10: "医療や住宅支援を含む国際学生向けの支援政策。",
        UniversityofToronto: 'トロント大学',
        McGillUniversity: 'マギル大学',
