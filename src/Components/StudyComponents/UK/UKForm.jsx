              ...
              <div className="relative">
                ...
                >
                  ...
                  <option value="University of Oxford">
                    {
                      language === "en" ? languageData.en.universityOxford : languageData.jp.universityOxford
                    }
                  </option>
                  <option value="University of Cambridge">
                    {
                      language === "en" ? languageData.en.universityCambridge : languageData.jp.universityCambridge
                    }
                  </option>
                  <option value="Imperial College London">
                    {
                      language === "en" ? languageData.en.imperialCollegeLondon : languageData.jp.imperialCollegeLondon 
                    }
                  </option>
                  <option value="London School of Economics and Political Science">
                    {
                      language === "en" ? languageData.en.LondonSchoolofEconomicsandPoliticalScience : languageData.jp.LondonSchoolofEconomicsandPoliticalScience
                    }
                  </option>
                  <option value="University College London">
                    {
                      language === "en" ? languageData.en.UniversityCollegeLondon : languageData.jp.UniversityCollegeLondon
                    }
                  </option>
                  <option value="University of Edinburgh">
                    {
                      language === "en" ? languageData.en.UniversityofEdinburgh : languageData.jp.UniversityofEdinburgh
                    }
                  </option>
                  <option value="University of Manchester">
                   {
                    language === "en" ? languageData.en.UniversityofManchester : languageData.jp.UniversityofManchester 
                   }
                  </option>
                  <option value="University of Glasgow">
                    {
                      language === "en" ? languageData.en.UniversityofGlasgow : languageData.jp.UniversityofGlasgow
                    }
                  </option>
                  <option value="King's College London">
                    {
                      language === "en" ? languageData.en.KingsCollegeLondon : languageData.jp.KingsCollegeLondon
                    }
                  </option>
                  <option value="University of Warwick">
                    {
                      language === "en" ? languageData.en.UniversityofWarwick : languageData.jp.UniversityofWarwick
                    }
                  </option>
