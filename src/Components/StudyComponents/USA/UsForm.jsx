              ...
              <div className="relative">
                ...
                >
                  ...
                  <option value="Harvard University">
                    {
                      language === 'en' ? languageData.en.harvardUniversity : languageData.jp.harvardUniversity
                    }
                  </option>
                  <option value="Stanford University">
                    {
                      language === 'en' ? languageData.en.stanfordUniversity : languageData.jp.stanfordUniversity
                    }
                  </option>
                  <option value="Massachusetts Institute of Technology">
                    {
                      language === 'en' ? languageData.en.MIT : languageData.jp.MIT
                    }
                  </option>
                  <option value="University of California, Berkeley">
                    {
                      language === 'en' ? languageData.en.UniversityofCaliforniaBerkeley : languageData.jp.UniversityofCaliforniaBerkeley
                    }
                  </option>
                  <option value="Columbia University">
                    {
                      language === 'en' ? languageData.en.ColumbiaUniversity : languageData.jp.ColumbiaUniversity
                    }
                  </option>
                  <option value="University of Chicago">
                   {
                    language === 'en' ? languageData.en.UniversityofChicago : languageData.jp.UniversityofChicago
                   }
                  </option>
                  <option value="Yale University">
                    {
                      language === 'en' ? languageData.en.YaleUniversity : languageData.jp.YaleUniversity
                    }
                  </option>
                  <option value="Princeton University">
                    {
                      language === 'en' ? languageData.en.PrincetonUniversity : languageData.jp.PrincetonUniversity
                    }
                  </option>
                  <option value="University of Michigan">
                    {
                      language === 'en' ? languageData.en.UniversityofMichigan : languageData.jp.UniversityofMichigan
                    }
                  </option>
                  <option value="New York University">
                    {
                      language === 'en' ? languageData.en.NewYorkUniversity : languageData.jp.NewYorkUniversity
                    }
                  </option>
